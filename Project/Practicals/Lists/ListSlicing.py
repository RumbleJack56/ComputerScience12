...
val = [10,20,30,40,1,2,3,100,200,10,20,30,11,12,15,17,19,90,77,]
a1 , a2 , s1 , s2 = val[5:15:2] , val[0::4] , 0 , 0
for j in a1:
    s1+=j
for j in a2:
    s2+=j
print('Sum of every other element between 5 and 15 is',s1)
print('The average of list 2 is',s2/len(a2))
