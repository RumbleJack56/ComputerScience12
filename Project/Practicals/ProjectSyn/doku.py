...
def enterInput(board):
    myBoard = [[0 for _ in range(9)] for __ in range(9)]
    print("""  Enter your values in following format
     x y v
     x is the x coordinate from left
     y is the y coordinate from top
     v is number in that position
...
print(" Hello Welcome to Sudoku Solver")
enterInput(myBoard)
solveBoard(myBoard)
printBoard(myBoard)
